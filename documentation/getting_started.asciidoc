...
Another variant that can be used to create a Flutter application is to use Visual Studio Code. Follow the installation instructions of the following link:https://code.visualstudio.com/[link] to install Visual Studio Code. 
